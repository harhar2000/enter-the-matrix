...
def link_welcome(name, custom_delay=0.02):
    ...
    paragraphs = [
        f"\n\n\nHey {name}, I'm Link, I'm going to break down what it means to be an Operator here in the real world. As Operators, we're the mission control for our crew inside the Matrix. We provide real-time support, from navigation to technical hacks, ensuring the team has everything they need for their missions.",
